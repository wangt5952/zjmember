  ...
  <div>
    ...
    <mt-tab-container v-model="selected" style="margin-top:49px;">
      <mt-tab-container-item id="1">
        <scroller lock-x>
          <div>
            <router-link :class="{gray:o.past}" :to="{path:'/gift_memVouDetail', query:{id:o.crl_id}}" style="display:flex;background-color:#fff;margin-top:1px;" key="crl_id" v-for="o in list">
      ...
      <mt-tab-container-item id="3">
        <scroller lock-x>
          <div class="gray">
            <router-link :to="{path:'/gift_memVouDetail', query:{id:o.crl_id}}" style="display:flex;background-color:#fff;margin-top:1px;" key="crl_id" v-for="o in list2">
              <div style="width:2.5rem;height:2.5rem;display:flex;align-items:center;justify-content:center;">
                <img :src="o.picture  || '/static/img/default-icon.jpg'" style="max-width:2rem;max-height:2rem;">
              </div>
              <div style="flex:1;">
...
export default {
  ...
  async mounted(){
    ...
    try{
      ...
      list = _.filter(list, o => o.expiry_date_end > moment().unix() * 1000);
    ...
    try{
      this.list2 = (await this.$http.post(`/api/giftCoupon/member/${this.member_id}/list`, {
